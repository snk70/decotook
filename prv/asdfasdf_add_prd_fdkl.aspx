<%@ Page Language="C#" AutoEventWireup="true" CodeFile="asdfasdf_add_prd_fdkl.aspx.cs" Inherits="prv_asdfasdf_add_prd_fdkl" %>
...
<body>
    ...
    <br />
        ...
        <asp:Label ID="lbl_link" runat="server" Text="لینک مطلب ( متن تنها )" 
            style="float:right;font-size:20px;" Height="20px"></asp:Label>
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:Button ID="btn_publish" runat="server" Height="108px" style="float:right;" Text="تأیید و انتشار" 
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:decotookdbConnectionString %>" 
            DeleteCommand="DELETE FROM [tbl_products] WHERE [r] = @r" 
            InsertCommand="INSERT INTO [tbl_products] ([cate_title], [title], [text_boy], [date], [time], [author], [auth_pic], [auth_title], [comment_code], [like_code], [telegram], [facebook], [print], [meta_title], [meta_desc], [paper_cmt], [paper_link], [img], [visit_number]) VALUES (@cate_title, @title, @text_boy, @date, @time, @author, @auth_pic, @auth_title, @comment_code, @like_code, @telegram, @facebook, @print, @meta_title, @meta_desc, @paper_cmt, @paper_link, @img, @visit_number)" 
            ProviderName="<%$ ConnectionStrings:decotookdbConnectionString.ProviderName %>" 
            SelectCommand="SELECT [r], [cate_title], [title], [text_boy], [date], [time], [author], [auth_pic], [auth_title], [comment_code], [like_code], [telegram], [facebook], [print], [meta_title], [meta_desc], [paper_cmt], [paper_link], [img], [visit_number] FROM [tbl_products]" 
            UpdateCommand="UPDATE [tbl_products] SET [cate_title] = @cate_title, [title] = @title, [text_boy] = @text_boy, [date] = @date, [time] = @time, [author] = @author, [auth_pic] = @auth_pic, [auth_title] = @auth_title, [comment_code] = @comment_code, [like_code] = @like_code, [telegram] = @telegram, [facebook] = @facebook, [print] = @print, [meta_title] = @meta_title, [meta_desc] = @meta_desc, [paper_cmt] = @paper_cmt, [paper_link] = @paper_link, [img] = @img, [visit_number] = @visit_number WHERE [r] = @r">
            <DeleteParameters>
                <asp:Parameter Name="r" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
