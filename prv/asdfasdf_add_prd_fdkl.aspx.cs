...
public partial class prv_asdfasdf_add_prd_fdkl : System.Web.UI.Page
{
    ...
    DataSet1TableAdapters.tbl_productsTableAdapter tb = new DataSet1TableAdapters.tbl_productsTableAdapter();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (prp_title.Text == "")
            {
                ...
                con2.Open();
                SqlCommand com2 = new SqlCommand("Select * From tbl_products Where(r='" + r_paper + "')", con2);
                ...
                editor_text_body.Text = dr2["text_boy"].ToString().Replace("img_special_url_address_pic", host_address + "/" + Edit_Content_class.Posts_link_Path + "/" + paper_link.Text);
        ...
        catch
        {
            ...
            try
            {
                ...
                con1.Open();
                SqlCommand com1 = new SqlCommand("SELECT MAX(r) FROM tbl_products", con1);
    ...
    {
        top_path = "<a class=\"pt3 fl_r\" href=\"../../index.php\">صفحه اصلی&ensp;</a><a class=\"pt3 fl_r\">/&ensp;</a><a href=\"../../products.php\" class=\"pt3 fl_r\">محصولات و خدمات&ensp;</a><a class=\"pt3 fl_r\">&ensp;/&ensp;</a><a href=\"#\" class=\"pt3 fl_r\">" + prp_title.Text + "</a>";
        ...
        if (Session["edi"].ToString() == "1")
        {
            ...
            if (wm.GetResponse() == "ok")
            {
                ...
                tb.Fill(ds.tbl_products);


                if (wm2.GetResponse() == "ok")
                {
                    editor_text_body.Text = editor_text_body.Text.Replace(host_address + "/" + Edit_Content_class.Posts_link_Path + "/" + paper_link.Text, "img_special_url_address_pic");
    ...
    protected void add_pic_Click(object sender, EventArgs e)
    {
        if (paper_link.Text != "" && Directory.Exists(MapPath("~/posts/" + paper_link.Text)) == false || Directory.Exists(MapPath("~/posts/" + paper_link.Text)) == true && Session["edi"].ToString() == "1")
        {
            ...
            editor_text_body.Text += "<img class=\"e-w\" alt=\"\" src=\"" + host_address + "/" + Edit_Content_class.Posts_link_Path + "/" + paper_link.Text + "/" + edi_add.FileName + "\">";
        }
    }
